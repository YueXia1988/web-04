...
{	
	...
	protected static function getDatabaseConnection(){
		...
		$dsn = 'mysql:host=localhost;dbname=SOC_Script;charset=utf8';
				...
				switch ($rule) {
					case 'minlength':
						if(strlen($this->$column)<$value){
							$valid = false;
							$this -> errors[$column]="Mucst be atleast $value characters long.";
						}
						break;
					case 'maxlength':
						if(strlen($this->$column)>$value){
							$valid = false;
							$this -> errors[$column]="Mucst be no more than $value characters.";
